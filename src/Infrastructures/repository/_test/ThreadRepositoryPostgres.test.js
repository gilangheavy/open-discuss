...
describe('ThreadRepositoryPostgres', () => {
  ...
  describe('getThreadById function', () => {
    ...
    it('should handle thread.date as string and convert to Date instance', async () => {
      // Arrange: mock pool to return thread with date as string
      const mockPool = {
        query: jest.fn().mockResolvedValue({
          rows: [
            {
